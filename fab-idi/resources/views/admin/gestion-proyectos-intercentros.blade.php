...
@section('content')
    ...
    <section id="section-table-proyectos-intercentros-destacados">
        ...
        <table class="table styled-table">
            ...
            <tbody id="tbody-tabla-proyectos-intercentros-destacados">
                @foreach ($proyectosDestacados as $proyecto)
                    <tr>
                        ...
                        <td>
                            <a href="{{ url('gestion-proyectos/editar/' . $proyecto->id) }}" class="btn btn-primary btn-admin-edit"><i class="fa-solid fa-pen-to-square"></i></a>
                            <a href="{{ url('gestion-proyectos/eliminar/' . $proyecto->id) }}" class="btn btn-danger btn-admin-delete"><i class="fa-solid fa-trash"></i></a>
                            <a href="{{ url('gestion-proyectos/quitar-destacado/' . $proyecto->id) }}" class="btn btn-admin-proyecto"><i class="fa-solid fa-eye-slash"></i></a>
    ...
    <section id="section-table-proyectos-intercentros-listado">
        ...
        <div class="input-group styled-input-group">
            ...
            <a href="{{ url('gestion-proyectos/crear') }}" class="btn btn-admin-add"><i class="fa fa-circle-plus"></i></a>
        </div>
